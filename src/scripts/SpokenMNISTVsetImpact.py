...
if __name__ == "__main__":
    ...
    processed_sample = processSample(sample, 
                                    preprocessor = "YananZhongEtAlPreprocessor", 
                                    preprocessor_params = preprocessor_params, 
                                    voltage_output_params = voltage_output_params, 
                                    save_directory_path = "data/SpokenMNISTVsets/ProcessedSamples") 
