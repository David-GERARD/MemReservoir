...
# This file contains functions for trimming silence from audio data and splitting audio data by silence.
# Code from: https://github.com/Jakobovski/free-spoken-digit-dataset/blob/master/utils/trimmer.py
